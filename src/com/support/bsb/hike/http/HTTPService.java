package com.support.bsb.hike.http;
...
import com.support.bsb.hike.qa.constants.AutomationConstants;
import com.support.bsb.hike.qa.dbmanager.MongoDBManagerUtil;
...
public class HTTPService {
    ...
    public static HttpPostResponse getData(String urlStr, String contentType, Map<String,String> headers, String dataToPost, String requestMethod) throws Exception
    {
        ...
        try {
            ...
            return new HttpPostResponse(connection.getResponseCode(),com.support.bsb.hike.util.IOUtil.readData(connection.getInputStream(), true));
