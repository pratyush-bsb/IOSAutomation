package com.support.bsb.hike.mqtt.client;
...
import com.support.bsb.hike.mqtt.msg.ConnAckMessage;
import com.support.bsb.hike.mqtt.msg.ConnectMessage;
import com.support.bsb.hike.mqtt.msg.DisconnectMessage;
import com.support.bsb.hike.mqtt.msg.Message;
import com.support.bsb.hike.mqtt.msg.MessageInputStream;
import com.support.bsb.hike.mqtt.msg.MessageOutputStream;
import com.support.bsb.hike.mqtt.msg.PingReqMessage;
import com.support.bsb.hike.mqtt.msg.PingRespMessage;
import com.support.bsb.hike.mqtt.msg.PubAckMessage;
import com.support.bsb.hike.mqtt.msg.PublishMessage;
import com.support.bsb.hike.mqtt.msg.QoS;
import com.support.bsb.hike.mqtt.msg.RetryableMessage;
import com.support.bsb.hike.mqtt.msg.SubAckMessage;
import com.support.bsb.hike.mqtt.msg.SubscribeMessage;
import com.support.bsb.hike.mqtt.msg.UnsubscribeMessage;
...
public class MqttConnection
{
	...
	protected void handleFailure(Throwable t){
		Reporter.log("Socket Failure From Server");
	}
	...
	protected void handleMessage(PingRespMessage msg) {
		Reporter.log("PING response came at "+new Date());
	}
	protected void handleMessage(PubAckMessage msg) {
		Reporter.log("PubAck came for msgId="+msg.getMessageId());
	}
	protected void handleMessage(SubAckMessage msg) {
		Reporter.log("SubAck came for msgId="+msg.getMessageId()+" "+msg.getGrantedQoSs().toString());
	}
