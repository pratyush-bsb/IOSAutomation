...
import com.support.bsb.hike.common.HikeConstants;
...
public class ConnectMessage extends Message
{
    ...
    {
        //Reporter.log("Client Id : " + clientId);
        ...
        if (parts.length > 1)
        {
            ...
            {
                Reporter.log("Invalid version " + clientId);
            }
        }
        if (parts.length > 2)
        {
            ...
            throws Exception
    {
        ...
        Reporter.log("clientId " + m.getClientId());
        Reporter.log("version " + m.getVersion());
    }
}
